...
<head>
  ...
  <link rel="stylesheet" href="https://fonts.google.com/specimen/Fraunces?query=fraun">
  ...
  <div class="container">
    ...
    <div class="productenkolom">
      <section class="container">
        ...
        <div class="card ">
          <div class="card-image car-16"></div>
          <h2>Design 08.</h2>
          <p class="omschrijving">Prijs wordt achteraf bepaald.</p>
          <a href="formulier.php" class="neon">Maak een afspraak.</a>
        </div>
        ...
        <div class="card">
          <div class="card-image  car-17"></div>
          <h2>Design 09.</h2>
          <p class="omschrijving">Prijs wordt achteraf bepaald.</p>
          <a href="formulier.php" class="neon">Maak een afspraak.</a>
        </div>
        ...
        <div class="card">
          <div class="card-image car-18"></div>
          <h2>Design 10.</h2>
          <p class="omschrijving">Prijs wordt achteraf bepaald.</p>
          <a href="formulier.php" class="neon">Maak een afspraak.</a>
        </div>
        ...
        <div class="card">
          <div class="card-image car-19"></div>
          <h2>Design 11.</h2>
          <p class="omschrijving">Prijs wordt achteraf bepaald.</p>
          <a href="formulier.php" class="neon">Maak een afspraak.</a>
        </div>
        ...
        <div class="card">
          <div class="card-image car-20"></div>
          <h2>Design 12.</h2>
          <p>Prijs wordt achteraf bepaald.</p>
          <a href="formulier.php" class="neon">Maak een afspraak.</a>
        </div>
      </section>
    </div>
